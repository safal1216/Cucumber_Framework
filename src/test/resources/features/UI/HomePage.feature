Feature: Website Login Tests
  ...
  Scenario Outline: Verify whether a client can find a workout
    ...
    Examples:
      ...
      | All           | 30   | 08:00 AM     | John Doe     |
      | All           | 30  |  All          | All          |
      | Yoga Expert   | 30   | 10:00 AM     | John Doe     |
  ...
  Scenario Outline: Verify the error message when time is invalid
    ...
    Examples:
      ...
      | All           | 29   | John Doe | 08:00 AM   | Please choose a valid time.  |
      | All           | 29   | All      | 10:00 AM   | Please choose a valid time.  |
      | Yoga Expert   | 29   |John Doe  | 10:00 AM   | Please choose a valid time. |
